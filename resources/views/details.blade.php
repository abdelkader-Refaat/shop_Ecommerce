                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        <div>
                                            <img src="../assets/images/fashion/product/front/{{$product->image}}" id="zoom_01"
                            ...
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                   ...
                                   $ {{$product->sale_price}}
                                    ...
                                    @endif
                                    <!--$13 <del>$459.00</del><span>55% off</span></h3> -->
                                ...
                                <div class="product-buttons">
                                    <a href="javascript:void(0)" class="btn btn-solid">
                                        <i class="fa fa-bookmark fz-16 me-2"> Wishlist</i>
                                    </a>
                                  ...
                                  <a href="{{Route('shop.product.details',['slug' => $product->slug])}}">
                                    @session('message')
                                    <h6 class="btn-solid"> added to cart </h6>
                                    @endsession
                                  </a>
                                    ...
                                    <div class="customer-review-box">
                                        ...
                                        <div class="customer-section">
                                            <div class="customer-profile">
                                                <img src="../assets/images/inner-page/review-image/{{$product->image}}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </div>
